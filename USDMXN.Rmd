...
### Se añade el archivo
```{r}
USDMXN_anuales <- read_xlsx("C:/Users/aalma/OneDrive/TEC/Carrera/CFA Challenge/Datos históricos USD_MXN (1).xlsx")
```
#El archivo incluye el tipo de cambio USD/MXN de forma anual desde el 1 de enero de 1990 hasta el 1 de enero del 2022

###Se crea una serie con los datos
```{r}
serie4 <- ts(USDMXN_anuales$Cierre)
```
